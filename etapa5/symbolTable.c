...
CONTEUDO *cria_conteudo(valor_lexico* vl, int tipo, int natureza, ARRANJOOUVETOR arrVec){
  ...
  {
  case literal_bool:
    conteudo->valor_literal.b = vl->literal.b;
    break;
  case literal_char:
    conteudo->valor_literal.s = vl->literal.s;
    break;
  case literal_float:
    conteudo->valor_literal.f = vl->literal.f;
    break;
  case literal_inteiro:
    conteudo->valor_literal.d = vl->literal.d;
    break;
  }
